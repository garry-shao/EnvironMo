...
public class WeatherSummary extends Fragment implements LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String[] projection = { WeatherEntity.CURRENT,
                WeatherEntity.FORECAST1,
                WeatherEntity.FORECAST2,
                WeatherEntity.FORECAST3 };
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (data != null && data.moveToFirst()) {
            ...
            forecasts[0] = data.getString(
                    data.getColumnIndexOrThrow(WeatherEntity.FORECAST1));
            forecasts[1] = data.getString(
                    data.getColumnIndexOrThrow(WeatherEntity.FORECAST2));
            forecasts[2] = data.getString(
                    data.getColumnIndexOrThrow(WeatherEntity.FORECAST3));
        }
