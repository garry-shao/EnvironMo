...
public class WeatherParser {
    ...
    /**
     * Invalid value of temperature, make sure below <b>Kelvin Zero</b>,
     * or "<b>Absolute Zero</b>".
     */
    ...
    public static int getWeatherId(String weatherRaw) {
        ...
        if ((length == Contract.SEGMENTS_CURRENT)
                || (length == Contract.SEGMENTS_FORECAST)) {
     ...
     * @return The valid minimum temperature of forecast
     *           weather or {@link #INVALID_TEMPERATURE}.
     */
     ...
     * @param weatherRaw
     *           The string of forecast weather retrieved from content provider.
     * @return The valid maximum temperature of forecast
     *           weather or {@link #INVALID_TEMPERATURE}.
     */
