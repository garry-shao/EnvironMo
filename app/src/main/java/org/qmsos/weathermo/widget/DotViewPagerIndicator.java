...
public class DotViewPagerIndicator extends View implements OnPageChangeListener {
    ...
    public DotViewPagerIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final int defaultSelectedColor = ContextCompat.getColor(getContext(),
                R.color.default_selected_color);
        final int defaultUnselectedColor = ContextCompat.getColor(getContext(),
                R.color.default_unselected_color);
        ...
        mRadius = a.getDimension(R.styleable.DotViewPagerIndicator_radius,
                defaultRadius);
        mPadding = a.getDimension(R.styleable.DotViewPagerIndicator_padding,
                defaultPadding);

        mSelectedPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mSelectedPaint.setColor(a.getColor(R.styleable.DotViewPagerIndicator_selectedColor,
                defaultSelectedColor));

        mUnselectedPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mUnselectedPaint.setColor(a.getColor(R.styleable.DotViewPagerIndicator_unselectedColor,
