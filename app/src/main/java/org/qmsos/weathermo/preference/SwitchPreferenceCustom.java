...
public class SwitchPreferenceCustom extends SwitchPreferenceCompat {
    ...
    public SwitchPreferenceCustom(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        String attributeTitle = a.getString(
                R.styleable.SwitchPreferenceCustom_switchPreferenceDialogTitle);
        String attributeMessage = a.getString(
                R.styleable.SwitchPreferenceCustom_switchPreferenceDialogMessage);
        String attributeNegativeButton = a.getString(
                R.styleable.SwitchPreferenceCustom_switchPreferenceNegativeButton);
        String attributePositiveButton = a.getString(
                R.styleable.SwitchPreferenceCustom_switchPreferencePositiveButton);
